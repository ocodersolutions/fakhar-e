...
class IndexController extends AbstractActionController
{
    public function indexAction()
    {
        ...
        $http_service = 'http://'.URL_MOBILE_APPLICATION.'/service';
        $https_service = 'https://'.URL_MOBILE_APPLICATION.'/service';
        if($ssSystem->offsetExists('previous-url') && ($ssSystem->offsetGet('previous-url') == $http_service || $ssSystem->offsetGet('previous-url') == $https_service)) {
