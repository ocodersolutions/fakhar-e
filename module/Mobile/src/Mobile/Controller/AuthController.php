  ...
  //   }
    ...
    public function fbLoginAction(){
        ...
        try {
            ...
            echo  json_encode(array('status'=>'fail','message'=>'Graph returned an error: ' . $e->getMessage()));
            die;
            
        } catch(Facebook\Exceptions\FacebookSDKException $e) {
            // When validation fails or other local issues
            echo  json_encode(array('status'=>'fail','message'=>'Facebook SDK returned an error: ' . $e->getMessage()));
            die;
        }
